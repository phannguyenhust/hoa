...
<head>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <tr dir-paginate = "ls in Sanpham| filter: timkiem|itemsPerPage:10">
                <td>@{{ $index+1 }}</td>
                <td>@{{ ls.tensp }}</td>
                <td>@{{ ls.mausac }}</td>
                <td>@{{ ls.mota }}</td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control" id="tensp" ng-model="sanpham.tensp">
                    </div>
                    
<div class="form-group">
                        <label for="mausac">Màu sắc</label>
                        <input type="text"
                          class="form-control" id="mausac" ng-model="sanpham.mausac">
                      </div>
                      <div class="form-group">
                      <label for="mota">Mô tả</label>
                      <input type="text"
                        class="form-control" id="mota" ng-model="sanpham.mota">
                    </div>
                    <div class="form-group">
                      <label for="dongia">Đơn giá</label>
                      <input type="text"
                        class="form-control" id="dongia" ng-model="sanpham.dongia">
                    </div>
                    <div class="form-group">
                      <label for="maloai">Mã loại</label>
                      <input type="text"
                        class="form-control" id="maloai" ng-model="sanpham.maloai">
                    </div>
                    <!-- <div class="form-group">
                      <label for="anh">Ảnh</label>
                      <img src="/upload/sanpham/@{{sanpham.anh}}" style='width:100px'>
                      <!-- <input type="text"
                        class="form-control" id="anh" ng-model="sanpham.anh" >
                    </div> -->
                </div> 
