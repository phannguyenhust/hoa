...
<body class="sb-nav-fixed">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <tr dir-paginate = "ls in Nhanvien| filter: timkiem|itemsPerPage:10">
                <td>@{{ $index+1 }}</td>
                <td>@{{ ls.tennv }}</td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control" id="tennv" ng-model="nhanvien.tennv">
                    </div>
                    
<div class="form-group">
                        <label for="sodienthoai">Số điện thoại</label>
                        <input type="text"
                          class="form-control" id="sodienthoai" ng-model="nhanvien.sodienthoai">
                      </div>
                      <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="diachinv">Địa chỉ nhân viên</label>
                      <input type="text"
                        class="form-control" id="diachinv" ng-model="nhanvien.diachinv">
                    </div>
