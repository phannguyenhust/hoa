                                ...
                                <?php 
                                        require "../databases/dbconnect.php";
                                                ...
                                                if(isset($_POST['cmd'])){
                                                    ...
                                                    $db =new dbconnect();
                                                    $sql = "UPDATE `san_pham` SET `name`='$name',`mota_sp`='$mota' WHERE id='$sid'";
                                                    $db->updateData($sql);
                                                    echo "<script>window.location.href = 'http://localhost/101198/admins/';</script>";
